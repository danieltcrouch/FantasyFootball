...
function storeDraftSettings( $settings )
{
	...
	$insertSLeague	= "INSERT INTO settingsLeague	(s_id, sl_qb, sl_rb, sl_wr, sl_te, sl_k, sl_dst, sl_dl, sl_lb, sl_db, sl_wrTe, sl_wrRb, sl_wrRbTe, sl_qbWrRbTe, sl_dlLbDb, sl_bench)
											 VALUES ('" . $settingsId . "', " . $settings->league->starters->qb . ", " . $settings->league->starters->rb . ", " . $settings->league->starters->wr . ", " . $settings->league->starters->te . ", " . $settings->league->starters->k . ", " . $settings->league->starters->dst . ", " . $settings->league->starters->dl . ", " . $settings->league->starters->lb . ", " . $settings->league->starters->db . ", " . $settings->league->starters->wrTe . ", " . $settings->league->starters->wrRb . ", " . $settings->league->starters->wrRbTe . ", " . $settings->league->starters->qbWrRbTe . ", " . $settings->league->starters->dlLbDb . ", " . $settings->league->starters->bench . " )";
...
function getDraftSettings( $memberId )
{
	...
	$result = $mysqli->query(
				"SELECT
					...
					tn.tn_teamName		AS teams_teamNames
				FROM members m
				...
				JOIN settingsTeams st ON m.s_id = st.s_id
					JOIN teamNames tn ON m.s_id = tn.s_id
